...
import PatientCard from '@/components/dashboard/agenda/PatientCard';
...
const dummyPatients: PatientInfo[] = [
    ...
    },
    {
        ...
        phone: '(555) 234-5678',
        imageUrl: '/avatars/jane-smith.jpg',
    },
    {
        ...
        phone: '(555) 345-6789',
        imageUrl: '/avatars/alice-johnson.jpg',
    },
    {
        ...
        phone: '(555) 456-7890',
        imageUrl: '/avatars/robert-brown.jpg',
    },
    {
        ...
        phone: '(555) 567-8901',
        imageUrl: '/avatars/emily-davis.jpg',
    },
];
